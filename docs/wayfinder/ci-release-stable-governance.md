...
| Registry release  | maintainer manual，受保护 branch         | `contents: read`、读取 candidate artifact、`id-token: write`；finalization step 才有受限 `contents: write` | publish、registry verify、tag、Release       |
